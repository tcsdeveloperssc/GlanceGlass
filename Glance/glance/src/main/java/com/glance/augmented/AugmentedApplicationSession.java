...
public class AugmentedApplicationSession implements UpdateCallbackInterface
{
    ...
    private AugmentedApplicationControl m_sessionControl;
    ...
    public AugmentedApplicationSession(AugmentedApplicationControl sessionControl)
    {
    ...
    {
        AugmentedApplicationException vuforiaException = null;
        m_activity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new AugmentedApplicationException(
                AugmentedApplicationException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new AugmentedApplicationException(
                    AugmentedApplicationException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws AugmentedApplicationException
    {
        String error;
        mCamera = camera;
        if (!CameraDevice.getInstance().init(camera))
        {
            ...
            Log.e(LOGTAG, error);
            throw new AugmentedApplicationException(
                AugmentedApplicationException.CAMERA_INITIALIZATION_FAILURE, error);
        } else {
        	 Log.d(LOGTAG, "!CameraDevice.getInstance().init(camera)");
        }
            ...
            CameraDevice.MODE.MODE_DEFAULT))
        {
       	 ...
       	 Log.d(LOGTAG, "!CameraDevice.getInstance().selectVideoMod CameraDevice.MODE.MODE_DEFAULT)");
        }
        ...
        if (!CameraDevice.getInstance().start())
        {
            ...
            throw new AugmentedApplicationException(
          	 ...
          	 Log.d(LOGTAG, "!CameraDevice.getInstance().start())");
        }
...
//        }
//       
        Log.d(LOGTAG, "!startAR done..");
    }
    
    
    // Stops any ongoing initialization, stops Vuforia
    public void stopAR() throws AugmentedApplicationException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new AugmentedApplicationException(
                    AugmentedApplicationException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new AugmentedApplicationException(
                    AugmentedApplicationException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void resumeAR() throws AugmentedApplicationException
    {
    ...
    public void pauseAR() throws AugmentedApplicationException
    {
        if (m_started)
            stopCamera();
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new AugmentedApplicationException(
                            AugmentedApplicationException.LOADING_TRACKERS_FAILURE,
                            logMessage);
                        Log.e(LOGTAG, logMessage);
                        m_sessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new AugmentedApplicationException(
                        AugmentedApplicationException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(AugmentedApplicationSession.this);
    ...
    private boolean setFocusMode(int mode) throws AugmentedApplicationException
    {
        boolean result = CameraDevice.getInstance().setFocusMode(mode);
        
        if (!result)
            throw new AugmentedApplicationException(
                AugmentedApplicationException.SET_FOCUS_MODE_FAILURE,
